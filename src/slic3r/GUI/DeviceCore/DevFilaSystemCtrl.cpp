...
// On N3F / N3S AMS units the printer accepts an `ams_filament_drying` command
// with mode=Off / OnTime / OnHumidity. Both helpers below mirror BBS's
// DevFilaSystem::CtrlAmsStartDryingHour / CtrlAmsStopDrying byte-for-byte —
// the wire shape is fixed by the printer firmware. See AMSDryControl.cpp for
// the dialog that calls them.
// -----------------------------------------------------------------------------
